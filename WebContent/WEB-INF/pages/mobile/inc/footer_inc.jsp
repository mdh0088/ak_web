...
<div id="footer" class="footer">
	<div>
		...
		<div class="footer-top">
			<div class="foo-top table">
				<div class="fo-logo"><img src="/img/mo-logo.png" alt="ak문화센터"/></div>
				<div>
					<div class="family-wr">
				...
				<div class="table">
					...
					<div class="fbox fbox02">
						<ul class="foo-ul foo-ul02">
							<li><a href="#"><img src="/img/facebook-icon.png" alt="페이스북"></a></li>
							<li><a href="#"><img src="/img/twitter-icon.png" alt="페이스북"></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="footer-wr">
			<div class="foo-div">
				<a href="#">
					<img src="/img/ak-members.png" alt="ak문화센터"/>
					<span class="fo-tit">AK MEMBERS<img src="/img/foo-icon01.png" alt="ak문화센터"/></span>
					<span class="fo-stit">다양한 혜택과 서비스를 만나다</span>
				</a>
			</div>
			<div class="foo-div foo-div02">
				<a href="#">
					<img src="/img/ak-mall.png" alt="ak문화센터"/>
					<span class="fo-tit">AK MALL<img src="/img/foo-icon01.png" alt="ak문화센터"/></span>
			...
			<div class="foo-div foo-div03">
				<a href="#">
					<img src="/img/ak-members.png" alt="ak문화센터"/>
					<span class="fo-tit">AK PLAZA<img src="/img/foo-icon01.png" alt="ak문화센터"/></span>
