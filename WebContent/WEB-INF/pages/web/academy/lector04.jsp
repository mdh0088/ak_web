...
<div class="cours-sec cours-sec01 bg-gray">
	<div class="mu-grid">
		...
		<form name ="recruit" action='/academy/save02' method='post' enctype="multipart/form-data">
			...
			<div class="lect-wr03">
				...
				<table>
					<tr>
						...
						<td>
							<ul class="td-chk02">
								<li><label for="class_type"><input type="radio"  name="class_type" value="S" onclick='choosetype("S")' checked="checked">AK시그니처 클래스</label></li>
					...
					<tr>
						<th>희망 지점 <span class="ro-chkinfo">(중복선택 가능)</span></th>
						<td>
							<ul class="td-chk02">
					...
					<tr>
						<th>희망 요일 <span class="ro-chkinfo">(중복선택 가능)</span></th>
						<td>
							<ul class="td-chk02">
			...
			<div class="lect-wr02 lect-wr03">
				...
				<table>
					<tr>
						<th>강좌명</th>
						<td>
							<input type="text" name="lect_nm" maxlength="20"  class="inp100" value="${LEC_NM}" placeholder="강좌명을 입력해주세요.">
						</td>
					</tr>
					<tr>
						<th>강좌 소개 및 특징 요약</th>
						<td>
							<textarea name="lect_info" onKeyUp="javascript:fnChkByte(this,'4000')"  placeholder="내용을 입력해주세요.(1,000자 이상)">${LEC_INFO}</textarea>
						</td>
					</tr>
					<tr id="signiture_area">
						<th>시그니처 클래스에 지원한 이유</th>
						<td>
							<textarea name="sig_info" onKeyUp="javascript:fnChkByte(this,'1000')" placeholder="내용을 입력해주세요.(1,000자 이상)">${SIG_INFO}</textarea>
						</td>
					</tr>
					<tr>
						<th>수강 대상 <span class="ro-chkinfo">(중복선택 가능)</span></th>
						<td>
							<ul class="td-chk02">
					...
					<tr>
						<th>진행 횟수 <span class="ro-chkinfo">(중복선택 가능)</span></th>
						<td>
							<ul class="td-chk02">
