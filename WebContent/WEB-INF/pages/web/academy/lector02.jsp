...
function pageMove(idx){
	...
	if (document.getElementsByName("agree_chk")[0].checked == true) {
		location.href='/academy/lector03?reg_no='+idx;
	}else{
		alert("동의를 해주세요.");
		return;
	}
		...
		<div class="lect-wr02">
			<table>
				...
				<tr>
					...
					<td><b class="font-120 color-blue text-deco">강사 지원자 자격 검토, 강좌 진행시 <br>기본 프로필 제공 공지 및 강좌관련 협의 시 <br>소통 경로 확보</b></td>
					<td rowspan="3">
						<ul>
				...
				<tr>
					<td class="bor-l"><b class="font-120 color-blue text-deco">고유식별 정보(주민등록 번호)</b>, 계좌정보 <Br> ※ 출강확정 강사에 한함</td>
					<td><b class="font-120 color-blue">세무신고, 원천징수영수증 발급</b><br><b>[국세기본법 시행령 제68조, 소득세법 제145조, 164조 의거] </b></td>
				</tr>
