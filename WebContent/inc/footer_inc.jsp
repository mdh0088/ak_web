...
<div id="footer" class="footer">
	<div>
		<div class="footer-top">
			<div class="foo-top">
				<div class="fo-logo"><img src="/img/fo-logo.png" alt="ak문화아카데미"/></div>
			</div>
				...
				<div class="table">
					...
					<div class="fbox fbox02">
						<ul class="foo-ul foo-ul02">
							<li><a href="https://www.facebook.com/AKplazaM" target="_blank"><img src="/img/facebook-icon.png" alt="페이스북">Facebook</a></li>
							<li><a href="https://twitter.com/AKPlaza_HQ" target="_blank"><img src="/img/twitter-icon.png" alt="페이스북">Twitter</a></li>
						</ul>
					</div>
		...
		<div class="footer-wr table">
			<div class="foo-div">
				<a href="#">
					<img src="/img/ak-members.png" alt="ak문화아카데미"/>
					<span class="fo-tit">AK MEMBERS<img src="/img/foo-icon01.png" alt="ak문화아카데미"/></span>
					<span class="fo-stit">다양한 혜택과 서비스를 만나다</span>
				</a>
			</div>
			<div class="foo-div foo-div02">
				<a href="#">
					<img src="/img/ak-mall.png" alt="ak문화아카데미"/>
					<span class="fo-tit">AK MALL<img src="/img/foo-icon01.png" alt="ak문화아카데미"/></span>
			...
			<div class="foo-div foo-div03">
				<a href="#">
					<img src="/img/ak-members.png" alt="ak문화아카데미"/>
					<span class="fo-tit">AK PLAZA<img src="/img/foo-icon01.png" alt="ak문화아카데미"/></span>
