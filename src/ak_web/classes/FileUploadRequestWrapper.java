...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
     ...
     * @param threshold 임시파일을 바이트단위까지 메모리에저장 초과되면 임시디렉토리에저장 -1 저장하지않음
     * @param max 최대업로드용량 바이트단위까지 -1 용량무제한
     * @param repositoryPath 임시저장경로
    ...
    private void parsing(HttpServletRequest request,
        ...
        if (FileUpload.isMultipartContent(request)) {
            ...
            diskFileUpload.setHeaderEncoding("EUC_KR");  //추가
            ...
            for (int i = 0 ; i < list.size() ; i++) {
                ...
                if (fileItem.isFormField()) {
                    ...
                    String value = fileItem.getString("EUC-KR"); //수정
